...
const Nachname = value => {
    if (value.length < 2 || value.length > 30) {
        return (
            <div className="alert alert-danger" role="alert">
                Nachname muss zwischen 6 und 30 Zeichen lang sein
            </div>
        );
    }
};
...
export class RegistrierenVeranstalter extends React.Component {
...
export default RegistrierenVeranstalter;